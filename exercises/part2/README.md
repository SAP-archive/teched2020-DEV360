...
4. Extract the values from the binding for the following parameters:
   ...
   **Save these values** as you will need them later in the exercise. These parameters will be used to obtain the oAuth token required to authenticate with the SAP Cloud Platform REST APIs.  
...
<p align="center" width="100%">
   <img src="/exercises/part2/images/curl_get_token.png" width="60%"/>
</p>
...
<p align="center" width="100%">
   <img src="/exercises/part2/images/apis_accounts.png" width="60%"/>
</p>  
...
<p align="center" width="100%">
   <img src="/exercises/part2/images/apis_execute.png" width="60%"/>
</p> 

8. The results are presented in the **response body**.  

<p align="center" width="100%">
   <img src="/exercises/part2/images/apis_responses.png" width="60%"/>
</p>  
...
1. Go back to the **SAP Cloud Platform - Core Service APIs** home page, click on the “Entitlements” tile to view the APIs related to the Entitlements service.  
 ...
 <p align="center" width="100%">
    <img src="/exercises/part2/images/apis_entitlements.png" width="60%"/>
 </p>  
...
5. The results are presented in the **Response body**.  
  ...
  <p align="center" width="100%">
     <img src="/exercises/part2/images/apis_entitlements_response.png" width="60%"/>
  </p>  
