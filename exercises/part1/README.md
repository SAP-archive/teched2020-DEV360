...
Unpack the archive and copy the client file (for example, sapcp.exe) to your local system. Make sure you have read and write permissions in the target folder to run the executable.  
